...
export class SpaceStationOverlay {
  ...
  constructor({ scene, onClose, onRepair }: SpaceStationOverlayOptions) {
    ...
    const panel = scene.add.rectangle(640, 360, 520, 348, 0x08111b, 0.98)
      .setDepth(PANEL_DEPTH + 1)
      .setStrokeStyle(3, 0x365a82, 0.86);
    const inset = scene.add.rectangle(640, 360, 500, 328, 0x0b1622, 0.98)
      .setDepth(PANEL_DEPTH + 1)
      .setStrokeStyle(1, 0x294563, 0.7);
    const header = scene.add.rectangle(640, 236, 472, 54, 0x0d1a2a, 0.98)
      .setDepth(PANEL_DEPTH + 1)
    ...
    this.statusText = scene.add.text(400, 402, "", {
      fontFamily: "Arial",
      fontSize: "14px",
      color: "#9fc6ff",
      lineSpacing: 5,
